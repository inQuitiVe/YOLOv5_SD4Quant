...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        ckpt['model'] = model.load_state_dict(ckpt['model'], strict=False)  # load        
        csd = intersect_dicts(csd, model.state_dict(), exclude=exclude)  # intersect
        model.ckpt['model'].float().state_dict()  # checkpoint state_dict as FP32
        csd = load_state_dict(csd, strict=False)  # load
